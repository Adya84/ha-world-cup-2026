...
def _serialise_match(match):
    ...
    return {
        ...
        "lineups": match.get("lineups") or match.get("lineupsData") or match.get("teamLineups") or match.get("apiFootballLineups") or match.get("matchLineups") or [],
        "lineupsData": match.get("lineupsData") or match.get("lineups") or [],
        "teamLineups": match.get("teamLineups") or [],
        "apiFootballLineups": match.get("apiFootballLineups") or [],
