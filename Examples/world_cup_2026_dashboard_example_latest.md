        ...
        cards:
          ...
          - type: markdown
            content: |
              ...
              <h2>🏆 {{ T.get('group','Group') }} A</h2> <table>
                <tr>
                  <th>{{ T.get('pos','Pos') }}</th><th>{{ T.get('team','Team') }}</th><th>P</th><th>W</th><th>D</th><th>L</th><th>GD</th><th>{{ T.get('pts','Pts') }}</th>
                </tr>
          ...
          - type: markdown
            content: |
              ...
              <h2>🏆 {{ T.get('group','Group') }} B</h2> <table>
                <tr>
                  <th>{{ T.get('pos','Pos') }}</th><th>{{ T.get('team','Team') }}</th><th>P</th><th>W</th><th>D</th><th>L</th><th>GD</th><th>{{ T.get('pts','Pts') }}</th>
                </tr>
                {% set s = state_attr('sensor.world_cup_standings', 'standings') or [] %}
          ...
          - type: markdown
            content: |
              ...
              <h2>🏆 {{ T.get('group','Group') }} E</h2> <table>
                <tr>
                  <th>{{ T.get('pos','Pos') }}</th><th>{{ T.get('team','Team') }}</th><th>P</th><th>W</th><th>D</th><th>L</th><th>GD</th><th>{{ T.get('pts','Pts') }}</th>
                </tr>
                {% set s = state_attr('sensor.world_cup_standings', 'standings') or [] %}
          ...
          - type: markdown
            content: |
              ...
              <h2>🏆 {{ T.get('group','Group') }} F</h2> <table>
                <tr>
                  <th>{{ T.get('pos','Pos') }}</th><th>{{ T.get('team','Team') }}</th><th>P</th><th>W</th><th>D</th><th>L</th><th>GD</th><th>{{ T.get('pts','Pts') }}</th>
                </tr>
                {% set s = state_attr('sensor.world_cup_standings', 'standings') or [] %}
          ...
          - type: markdown
            content: |
              ...
              <h2>🏆 {{ T.get('group','Group') }} I</h2> <table>
                <tr>
                  <th>{{ T.get('pos','Pos') }}</th><th>{{ T.get('team','Team') }}</th><th>P</th><th>W</th><th>D</th><th>L</th><th>GD</th><th>{{ T.get('pts','Pts') }}</th>
                </tr>
                {% set s = state_attr('sensor.world_cup_standings', 'standings') or [] %}
          ...
          - type: markdown
            content: |
              ...
              <h2>🏆 {{ T.get('group','Group') }} J</h2> <table>
                <tr>
                  <th>{{ T.get('pos','Pos') }}</th><th>{{ T.get('team','Team') }}</th><th>P</th><th>W</th><th>D</th><th>L</th><th>GD</th><th>{{ T.get('pts','Pts') }}</th>
                </tr>
                {% set s = state_attr('sensor.world_cup_standings', 'standings') or [] %}
        ...
        cards:
          ...
          - type: markdown
            content: |
              ...
              <h2>🏆 {{ T.get('group','Group') }} C</h2> <table>
                <tr>
                  <th>{{ T.get('pos','Pos') }}</th><th>{{ T.get('team','Team') }}</th><th>P</th><th>W</th><th>D</th><th>L</th><th>GD</th><th>{{ T.get('pts','Pts') }}</th>
                </tr>
                {% set s = state_attr('sensor.world_cup_standings', 'standings') or [] %}
          ...
          - type: markdown
            content: |
              ...
              <h2>🏆 {{ T.get('group','Group') }} D</h2> <table>
                <tr>
                  <th>{{ T.get('pos','Pos') }}</th><th>{{ T.get('team','Team') }}</th><th>P</th><th>W</th><th>D</th><th>L</th><th>GD</th><th>{{ T.get('pts','Pts') }}</th>
                </tr>
                {% set s = state_attr('sensor.world_cup_standings', 'standings') or [] %}
          ...
          - type: markdown
            content: |
              ...
              <h2>🏆 {{ T.get('group','Group') }} G</h2> <table>
                <tr>
                  <th>{{ T.get('pos','Pos') }}</th><th>{{ T.get('team','Team') }}</th><th>P</th><th>W</th><th>D</th><th>L</th><th>GD</th><th>{{ T.get('pts','Pts') }}</th>
                </tr>
                {% set s = state_attr('sensor.world_cup_standings', 'standings') or [] %}
          ...
          - type: markdown
            content: |
              ...
              <h2>🏆 {{ T.get('group','Group') }} H</h2> <table>
                <tr>
                  <th>{{ T.get('pos','Pos') }}</th><th>{{ T.get('team','Team') }}</th><th>P</th><th>W</th><th>D</th><th>L</th><th>GD</th><th>{{ T.get('pts','Pts') }}</th>
                </tr>
                {% set s = state_attr('sensor.world_cup_standings', 'standings') or [] %}
          ...
          - type: markdown
            content: |
              ...
              <h2>🏆 {{ T.get('group','Group') }} K</h2> <table>
                <tr>
                  <th>{{ T.get('pos','Pos') }}</th><th>{{ T.get('team','Team') }}</th><th>P</th><th>W</th><th>D</th><th>L</th><th>GD</th><th>{{ T.get('pts','Pts') }}</th>
                </tr>
                {% set s = state_attr('sensor.world_cup_standings', 'standings') or [] %}
          ...
          - type: markdown
            content: |
              ...
              <h2>🏆 {{ T.get('group','Group') }} L</h2> <table>
                <tr>
                  <th>{{ T.get('pos','Pos') }}</th><th>{{ T.get('team','Team') }}</th><th>P</th><th>W</th><th>D</th><th>L</th><th>GD</th><th>{{ T.get('pts','Pts') }}</th>
                </tr>
                {% set s = state_attr('sensor.world_cup_standings', 'standings') or [] %}
        ...
        cards:
          ...
          - type: markdown
            content: >
              ...
              # 🏟️ {{ T.get('fixtures_stadiums','Fixtures & Stadiums') }}
              ...
              {{ T.get('no_fixtures','No fixtures available.') }}
              ...
              <table>
                <tr>
                  <th>Date</th>
                  <th>KO</th>
                  <th>{{ T.get('match','Match') }}</th>
                  <th>{{ T.get('stadium','Stadium') }}</th>
                  <th></th>
                </tr>
              ...
              <div style="margin-top:10px; color:#00ffff;">
                🕒 {{ T.get('scheduled','Scheduled') }} &nbsp;&nbsp;
                🔴 {{ T.get('live','Live') }} &nbsp;&nbsp;
                ⏸️ {{ T.get('half_time','Half Time') }} &nbsp;&nbsp;
                🏁 {{ T.get('full_time','Full Time') }}
              </div>
            card_mod:
              style: |
                ha-card {
        ...
        cards:
          ...
          - type: markdown
            content: >
              ...
              # 🏆 {{ T.get('golden_boot_race','Golden Boot Race') }}
              ...
              ⚽ {{ T.get('no_goals','No goals scored yet') }}
          ...
          - type: markdown
            content: >
              ...
              # 👟 {{ T.get('golden_boot_podium','Golden Boot Podium') }}
              ...
              {{ T.get('waiting_scorer_data','Waiting for scorer data...') }}
          ...
          - type: markdown
            content: >
              ...
              🎯 {{ T.get('no_assists','No assists yet') }}
          ...
          - type: markdown
            content: >
              ...
              ## ⚽ {{ T.get('latest_results','Latest Results') }}
              ...
              {% if results | count == 0 %}
                {{ T.get('no_matches_completed','No matches completed yet.') }}
              {% else %}
        ...
        cards:
          ...
          - type: markdown
            content: >
              ...
              <h2>🔴 {{ T.get('live','Live') }} Matches</h2>

              {% if live | count == 0 %}
                <p>{{ T.get('no_live_matches','No live matches right now.') }}</p>
              {% else %}
                {% for m in live %}
        ...
        cards:
          ...
          - type: markdown
            content: >
              ...
              # ⏳ {{ T.get('tournament_countdown','Tournament Countdown') }}
              ...
              🏆 {{ T.get('world_cup_starts_in','World Cup starts in') }}


              # {{ days }} {{ T.get('days','Days') }}


              {% if days <= 1 %}

              ## 🏆 {{ T.get('kickoff_imminent','Kickoff Imminent') }} 🏆

              {% elif days <= 3 %}

              ## ⚽ {{ T.get('almost_time','Almost Time!') }}

              {% elif days <= 7 %}

              ## 🏟️ {{ T.get('one_week_to_go','One Week To Go') }}
          ...
          - type: markdown
            content: >
              ...
              # ⚽ {{ T.get('next_kickoff','Next Kick-Off') }}
              ...
              {% else %}
                {{ T.get('no_upcoming','No upcoming fixtures found.') }}
              {% endif %}
            card_mod:
              style: |
                ha-card {
        ...
        cards:
          - type: markdown
            content: >
              ...
              <h1>🏆 {{ T.get('knockout_stage','Knockout Stage') }}</h1>

              <h3>{{ T.get('live_bracket','Live bracket will fill automatically
              when knockout fixtures appear.') }} appear.</h3>
              ...
              {% if ko | count == 0 %}
                <p>{{ T.get('no_knockout','No knockout fixtures available yet.') }}</p>
              {% else %}
          ...
          - type: markdown
            content: >
              ...
              # 🏆 {{ T.get('knockout_stage','Knockout Stage') }}
              ...
              ### 🌍 {{ T.get('teams_remaining','Teams Remaining') }}

              # {{ teams }}


              ### ❌ {{ T.get('eliminated','Eliminated') }}

              # {{ 48 - teams }}


              ### ⚽ {{ T.get('matches_remaining','Matches Remaining') }}
        ...
        cards:
          ...
          - type: markdown
            content: >
              ...
              # 📊 {{ T.get('tournament_progress','Tournament Progress') }}
              ...
              {{ T.get('matches_played','Matches Played') }}:


              ## {{ played }}


              {{ T.get('total_matches','Total Matches') }}:
        ...
        cards:
          ...
          - type: markdown
            content: |
              ...
              # 🏆 {{ T.get('tournament_records','Tournament Records') }}

              ## 🔥 {{ T.get('biggest_win','Biggest Win') }}
              # {{ states('sensor.world_cup_biggest_win') }}

              ## 🚀 {{ T.get('highest_scoring_match','Highest Scoring Match') }}
              # {{ states('sensor.world_cup_highest_scoring_match') }}

              ## ⚽ {{ T.get('top_scoring_team','Top Scoring Team') }}
              # {{ states('sensor.world_cup_top_scoring_team') }}

              ## 🛡️ {{ T.get('best_defence','Best Defence') }}
              # {{ states('sensor.world_cup_best_defence') }}

              ## 📰 {{ T.get('latest_result','Latest Result') }}
        ...
        cards:
          - type: markdown
            content: |
              ...
              # 🏟️ {{ T.get('world_cup_stadiums','World Cup Stadiums') }}

              <table width="100%">
                <tr>
                  <th>{{ T.get('country','Country') }}</th>
                  <th>{{ T.get('stadium','Stadium') }}</th>
                  <th>{{ T.get('city','City') }}</th>
                </tr>
        ...
        cards:
          ...
          - type: markdown
            content: >
              ...
              # 📊 {{ T.get('stats_hub','World Cup Stats Hub') }}
              ...
              <table>
                <tr><td>🏆 {{ T.get('current_stage','Current Stage') }}</td><td>{{ states('sensor.world_cup_current_stage') }}</td></tr>
                <tr><td>⏳ {{ T.get('days_until_kickoff','Days Until Kickoff') }}</td><td>{{ states('sensor.world_cup_countdown') }}</td></tr>
                <tr><td>🏁 {{ T.get('days_until_final','Days Until Final') }}</td><td>{{ states('sensor.world_cup_days_until_final') }}</td></tr>
                <tr><td>📈 {{ T.get('tournament_progress','Tournament Progress') }}</td><td>{{ states('sensor.world_cup_progress') }}%</td></tr>
                <tr><td>⚽ {{ T.get('matches_played','Matches Played') }}</td><td>{{ states('sensor.world_cup_total_matches_played') }} / 104</td></tr>
                <tr><td>🧮 {{ T.get('matches_remaining','Matches Remaining') }}</td><td>{{ states('sensor.world_cup_matches_remaining') }}</td></tr>

                {% if played == 0 %}
                <tr><td>🌍 {{ T.get('teams_entered','Teams Entered') }}</td><td>48</td></tr>
                <tr><td>❌ {{ T.get('teams_eliminated','Teams Eliminated') }}</td><td>0</td></tr>
                {% else %}
                <tr><td>🌍 {{ T.get('teams_remaining','Teams Remaining') }}</td><td>{{ teams }}</td></tr>
                <tr><td>❌ {{ T.get('teams_eliminated','Teams Eliminated') }}</td><td>{{ 48 - teams }}</td></tr>
                {% endif %}

                <tr><td>⚽ {{ T.get('total_goals','Total Goals') }}</td><td>{{ states('sensor.world_cup_total_goals') }}</td></tr>
                <tr><td>📊 {{ T.get('goals_per_match','Goals / Match') }}</td><td>{{ states('sensor.world_cup_goals_per_match') }}</td></tr>
                <tr><td>🔴 {{ T.get('live','Live') }} Goals</td><td>{{ states('sensor.world_cup_live_goals') }}</td></tr>
                ...
                <tr><td>👟 {{ T.get('top_scorer','Top Scorer') }}</td><td>{{ states('sensor.world_cup_top_scorer') }}</td></tr>
                <tr><td>🎯 {{ T.get('top_assist','Top Assist') }}</td><td>{{ states('sensor.world_cup_top_assist') }}</td></tr>
